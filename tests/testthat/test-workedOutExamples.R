...
test_that("EQR-results on page 22 can be reproduced.", {
    ...
    expect_that(result$PROB_lt, equals(0.988412826))
    expect_that(result$PROB_gt, equals(0.011587173501))
})
...
test_that("DCA-results on page 24 can be reproduced.", {
    ...
    expect_that(result$PROB_lt, equals(0.7372895))
    expect_that(result$PROB_gt, equals(0.2627105))
})
